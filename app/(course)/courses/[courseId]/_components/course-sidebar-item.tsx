  ...
  return (
    <button
      ...
      className={cn(
        ...
        isActive &&
          "text-slate-700 bg-slate-200/20 hover:bg-slate-200/20 hover:text-slate-700 dark:text-slate-300 dark:bg-slate-800 dark:hover:bg-slate-700/20 dark:hover:text-slate-100",
        isCompleted &&
